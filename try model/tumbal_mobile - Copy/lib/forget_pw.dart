    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          Get.snackbar(
            'Error',
            responseBody['message'] ?? 'Kode OTP tidak valid',
            backgroundColor: Colors.red[100],
            colorText: Colors.red[800],
            snackPosition: SnackPosition.BOTTOM,
            margin: const EdgeInsets.all(16),
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          Get.snackbar(
            'Error',
            responseBody['message'] ?? 'Gagal reset password',
            backgroundColor: Colors.red[100],
            colorText: Colors.red[800],
            snackPosition: SnackPosition.BOTTOM,
            margin: const EdgeInsets.all(16),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Kode OTP telah dikirim ke ${_emailController.text}. Silakan periksa email Anda.',
      ...
      case 1:
        return Column(
          children: [
            ...
            _buildInputField(
              label: "Kode OTP",
              hint: "Masukkan kode OTP dari email",
              icon: Icons.security,
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: const Color.fromARGB(1, 46, 125, 50)
                                  .withOpacity(0.3),
                              blurRadius: 20,
                              spreadRadius: 1,
                            ),
